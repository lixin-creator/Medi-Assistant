"""
MediAssistant 鈥?tools/duckduckgo_search.py
DuckDuckGo search tool 鈥?placeholder for future use.

This module provides a free, no-API-key alternative to Serper for web search.
